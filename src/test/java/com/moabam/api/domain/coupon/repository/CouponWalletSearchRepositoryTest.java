...
class CouponWalletSearchRepositoryTest {
	...
	void findAllByIdAndMemberId_success() {
		...
		// When
		List<CouponWallet> actual = couponWalletSearchRepository
			.findAllByIdAndMemberId(couponWallet.getId(), 1L);
	...
	@ParameterizedTest
	void findAllByIdAndMemberId_Id1_success(List<CouponWallet> couponWallets) {
		// Given
		...
		// When
		List<CouponWallet> actual = couponWalletSearchRepository.findAllByIdAndMemberId(null, 1L);
	...
	@MethodSource("com.moabam.support.fixture.CouponWalletFixture#provideCouponWalletAll")
	@ParameterizedTest
	void findAllByIdAndMemberId_Id2_notCouponId777(List<CouponWallet> couponWallets) {
		// Given
		couponWallets.forEach(couponWallet -> {
			Coupon coupon = couponRepository.save(couponWallet.getCoupon());
			couponWalletRepository.save(CouponWallet.create(couponWallet.getMemberId(), coupon));
		...
		// When
		List<CouponWallet> actual = couponWalletSearchRepository.findAllByIdAndMemberId(777L, 2L);
	...
	@MethodSource("com.moabam.support.fixture.CouponWalletFixture#provideCouponWalletAll")
	@ParameterizedTest
	void findAllByIdAndMemberId_Id3_success(List<CouponWallet> couponWallets) {
		// Given
		couponWallets.forEach(couponWallet -> {
			Coupon coupon = couponRepository.save(couponWallet.getCoupon());
			couponWalletRepository.save(CouponWallet.create(couponWallet.getMemberId(), coupon));
		...
		// When
		List<CouponWallet> actual = couponWalletSearchRepository.findAllByIdAndMemberId(null, 3L);
